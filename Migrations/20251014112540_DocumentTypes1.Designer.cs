...
namespace Paper_Route.Migrations
{
    ...
    [Migration("20251014112540_DocumentTypes1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Paper_Route.Models.Documents.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Paper_Route.Models.Documents.DocumentCaseFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Paper_Route.Models.Documents.DocumentTypeEntity", b =>
                {
                    ...
                    b.Property<bool>("IsRequiredForVerification")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Paper_Route.Models.Documents.Document", b =>
                {
                    b.HasOne("Paper_Route.Models.Documents.DocumentTypeEntity", "DocumentType")
                        .WithMany()
            ...
            modelBuilder.Entity("Paper_Route.Models.Documents.DocumentCase", b =>
                {
                    b.HasOne("Paper_Route.Models.Documents.DocumentRequestType", "RequestType")
                        .WithMany("DocumentCases")
            ...
            modelBuilder.Entity("Paper_Route.Models.Documents.DocumentCaseFile", b =>
                {
                    b.HasOne("Paper_Route.Models.Documents.DocumentCase", "DocumentCase")
                        .WithMany("Files")
                        .HasForeignKey("DocumentCaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Paper_Route.Models.Documents.Document", "Document")
                        .WithMany()
